...
def main(start_time_str='2024-07-30T00:00:00Z', end_time_str='2024-07-30T23:59:59Z', latitude=51.1950, longitude=0.2757, res_minutes = 1, length = 20, radius = 5):
    # Create Polytunnel instance
    tunnel = Polytunnel(radius=radius, length=length, resolution=res_minutes)
    ...
    irradiance_tot = ray_tracer.trace_rays(ground_grid_x, ground_grid_y, sun_positions)
    ...
    viz.plot_irradiance(ground_grid_x, ground_grid_y, irradiance_tot)
...
if __name__ == '__main__':
    ...
    if len(sys.argv) == 1:
        ...
        main(start_time_str, end_time_str, latitude, longitude, res_minutes, length, radius)
    else:
